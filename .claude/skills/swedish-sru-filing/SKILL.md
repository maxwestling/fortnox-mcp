...
| An INK2S value | INK2S codes are NOT auto-derived from BAS accounts — they are tax adjustments requiring manual calculation | Take them from the tax computation, not the ledger |
